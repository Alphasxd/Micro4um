...
type Service struct {
	...
	Kafka *Service_Kafka `protobuf:"bytes,2,opt,name=kafka,proto3" json:"kafka,omitempty"`
}
...
func (x *Service) GetKafka() *Service_Kafka {
	if x != nil {
		return x.Kafka
	}
	return nil
...
func (x *Service_Kafka) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Service_Kafka) ProtoMessage() {}

func (x *Service_Kafka) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Service_Kafka.ProtoReflect.Descriptor instead.
func (*Service_Kafka) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3, 1}
}

func (x *Service_Kafka) GetAddr() []string {
	if x != nil {
		return x.Addr
	}
	return nil
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x65, 0x52, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0xb8, 0x02, 0x0a,
	...
	0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xde, 0x01, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61,
	...
	0x65, 0x1a, 0x35, 0x0a, 0x05, 0x52, 0x65, 0x64, 0x69, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x6e, 0x65,
	...
	,
	...
	0x65, 0x6f, 0x75, 0x74, 0x1a, 0x1b, 0x0a, 0x05, 0x4b, 0x61, 0x66, 0x6b, 0x61, 0x12, 0x12, 0x0a,
	0x04, 0x61, 0x64, 0x64, 0x72, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x61, 0x64, 0x64,
	0x72, 0x42, 0x20, 0x5a, 0x1e, 0x66, 0x6f, 0x72, 0x75, 0x6d, 0x2d, 0x63, 0x68, 0x65, 0x63, 0x6b,
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Service_Etcd)(nil),        // 8: kratos.api.Service.Etcd
	(*Service_Kafka)(nil),       // 9: kratos.api.Service.Kafka
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 7: kratos.api.Service.etcd:type_name -> kratos.api.Service.Etcd
	9,  // 8: kratos.api.Service.kafka:type_name -> kratos.api.Service.Kafka
	...
	10, // 11: kratos.api.Service.Etcd.timeout:type_name -> google.protobuf.Duration
